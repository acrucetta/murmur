...
_CATALOG_ALIASES: dict[str, tuple[str, str, str, bool]] = {
    ...
    "moonshine-base": ("moonshine", "base-en", "moonshine", False),
    "moonshine-base-streaming": ("moonshine", "base-en", "moonshine", False),
    "base": ("moonshine", "base-en", "moonshine", False),
    "base-streaming": ("moonshine", "base-en", "moonshine", False),
    "base-streaming-en": ("moonshine", "base-en", "moonshine", False),
    "base-en": ("moonshine", "base-en", "moonshine", False),
...
_CATALOG_ENTRIES: list[ASRModelCatalogEntry] = [
    ...
    ASRModelCatalogEntry(
        ...
        provider="moonshine",
        runtime_model="base-en",
        note="Moonshine base model (English).",
    ),
    ASRModelCatalogEntry(
